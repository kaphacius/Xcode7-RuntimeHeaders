...
@interface FROnboardingCardViewController : UIViewController <UIScrollViewDelegate, UIGestureRecognizerDelegate, FROnboardingAnimationEngineDelegate, FROnboardingFirstAppearanceAnimatorDelegate, FROnboardingExitAnimatorDelegate, FROnboardingScrollDriftAnimatorDelegate, FROnboardingSubscribableItemCardCellAccessibilityInfoProvider>
{
    ...
    NSDate *_viewShowDate;
    UIActivityIndicatorView *_spinner;
    struct CGPoint _lastContentOffsetOnScroll;
}

@property(retain, nonatomic) UIActivityIndicatorView *spinner; // @synthesize spinner=_spinner;
@property(copy, nonatomic) NSDate *viewShowDate; // @synthesize viewShowDate=_viewShowDate;
...
- (id).cxx_construct;
- (void).cxx_destruct;
- (void)_addItemsForDemo:(long long)arg1;
...
- (void)_completingFirstAppearAnimationState;
...
- (void)_addFirstAppearanceAnimators;
- (void)_beginFirstAppearAnimationState;
- (void)transitionToState:(long long)arg1;
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;
- (void)_selectItem:(id)arg1 animated:(_Bool)arg2 quickPress:(_Bool)arg3;
...
- (void)setItem:(id)arg1 selected:(_Bool)arg2 animated:(_Bool)arg3 quickPress:(_Bool)arg4;
