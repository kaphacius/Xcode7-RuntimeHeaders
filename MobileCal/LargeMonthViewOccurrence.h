...
- (double)_newXPositionAfterDrawingTime:(id)arg1 textRect:(struct CGRect)arg2 color:(id)arg3;
- (id)_timeString:(id)arg1;
- (struct UIEdgeInsets)_textInsets;
- (struct CGPoint)_pointForDotInFrame:(struct CGRect)arg1;
...
- (id)initWithOccurrence:(id)arg1 forDayRange:(struct _NSRange)arg2 isZoomedDay:(_Bool)arg3;
- (id)_strikeColor;
- (id)_timeColor;
- (id)_titleColor;
