...
@property(retain) NSObject<OS_dispatch_queue> *bridgeQueue; // @synthesize bridgeQueue=_bridgeQueue;
@property(retain) NSMutableDictionary *machServices; // @synthesize machServices=_machServices;
@property(retain) NSObject<OS_dispatch_queue> *machServicesQueue; // @synthesize machServicesQueue=_machServicesQueue;
...
@property(readonly, retain) SimDeviceSet *deviceSet;
