...
@property(retain) NSObject<OS_dispatch_queue> *framebufferPortQueue; // @synthesize framebufferPortQueue=_framebufferPortQueue;
@property(retain) NSObject<OS_dispatch_source> *framebufferPortSource; // @synthesize framebufferPortSource=_framebufferPortSource;
