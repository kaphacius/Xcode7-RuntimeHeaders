...
- (id)initWithManeuverType:(int)arg1 drivingSide:(int)arg2 instructions:(id)arg3 distanceText:(id)arg4 shieldImage:(id)arg5 shieldCenterAt:(struct CGPoint)arg6 withinManeuver:(_Bool)arg7;
- (id)description;
