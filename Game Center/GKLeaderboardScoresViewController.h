...
@interface GKLeaderboardScoresViewController : GKCollectionViewController <UIPopoverPresentationControllerDelegate, UICollectionViewDelegate>
{
    ...
    long long _numberOfLeaderboardColumns;
    struct _NSRange _shownRange;
}

@property(nonatomic) long long numberOfLeaderboardColumns; // @synthesize numberOfLeaderboardColumns=_numberOfLeaderboardColumns;
