...
@property(nonatomic) _Bool hasPendingAddFriend; // @synthesize hasPendingAddFriend=_hasPendingAddFriend;
...
- (void)showAccountControllerForPlayer:(id)arg1 mode:(long long)arg2 url:(id)arg3 postBody:(id)arg4;
- (void)showAccountControllerForPlayer:(id)arg1 mode:(long long)arg2;
- (_Bool)shouldReuseControllerForLocalPlayer:(id)arg1 mode:(long long)arg2;
