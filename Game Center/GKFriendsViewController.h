...
- (void)showRequests;
- (_Bool)masterDetailViewControllerShouldUnhidePrimaryViewController:(id)arg1;
...
- (void)showPopoverWithNavigationController:(id)arg1 highlightTarget:(id)arg2 arrowDirection:(unsigned long long)arg3 completion:(CDUnknownBlockType)arg4;
- (void)addFriend;
...
- (_Bool)masterDetailViewControllerShouldCollapseToDetailView:(id)arg1;
