...
@property(retain, nonatomic) NSArray *headerLandscapeRTLConstraints; // @synthesize headerLandscapeRTLConstraints=_headerLandscapeRTLConstraints;
...
- (void)selectTabBarViewControllerByAppDelegateSelector:(SEL)arg1 fromBubble:(id)arg2 animated:(_Bool)arg3;
...
- (double)bubbleDimensionForViewSize:(struct CGSize)arg1;
- (void)loadView;
