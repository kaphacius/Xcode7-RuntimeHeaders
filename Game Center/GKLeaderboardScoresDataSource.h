...
- (_Bool)needCompareShowcaseCell:(long long)arg1 withMaxRank:(unsigned long long)arg2;
- (_Bool)needCompareShowcaseCell:(long long)arg1;
- (_Bool)needShowcaseCell:(long long)arg1 withMaxRank:(unsigned long long)arg2;
- (_Bool)needShowcaseCell:(long long)arg1;
