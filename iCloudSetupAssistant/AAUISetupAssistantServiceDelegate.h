...
- (void)setupMailAccount:(id)arg1 password:(id)arg2 handler:(CDUnknownBlockType)arg3;
- (_Bool)needSetupForMailAccount:(id)arg1;
- (_Bool)canAutoSetupMailAccount:(id)arg1;
- (void)verifyAccountWithAppleID:(id)arg1 handler:(CDUnknownBlockType)arg2;
- (void)completeEnablingCloudServicesWithHandler:(CDUnknownBlockType)arg1;
- (void)setBackupEnabled:(_Bool)arg1 handler:(CDUnknownBlockType)arg2;
...
- (void)setCloudServicesEnabled:(_Bool)arg1 handler:(CDUnknownBlockType)arg2;
