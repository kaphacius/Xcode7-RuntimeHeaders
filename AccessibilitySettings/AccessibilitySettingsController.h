...
- (void)_handleInvertColorsEnabled:(_Bool)arg1 specifier:(id)arg2;
- (void)disableOption:(id)arg1;
- (void)confirmDisablingWithString:(id)arg1 forKey:(id)arg2 confirmedBlock:(CDUnknownBlockType)arg3 canceledBlock:(CDUnknownBlockType)arg4 inWindow:(id)arg5;
