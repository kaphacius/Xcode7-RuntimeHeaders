...
- (void)assetManagerVoiceLanguageDownloadProgress:(NSString *)arg1 alternateVoiceId:(NSString *)arg2 progress:(float)arg3 storageSize:(long long)arg4 requiredDiskSpace:(_Bool)arg5 versionId:(NSString *)arg6;
