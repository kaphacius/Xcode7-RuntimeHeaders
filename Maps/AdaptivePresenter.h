...
+ (id)navigationPresenterForContentViewController:(id)arg1 rootViewControllerNotificationName:(id)arg2 willAdaptToNewPresentation:(CDUnknownBlockType)arg3 didDismissViewController:(CDUnknownBlockType)arg4;
+ (id)navigationPresenterForContentViewController:(id)arg1 rootViewControllerNotificationName:(id)arg2 willAdaptToNewPresentation:(CDUnknownBlockType)arg3;
+ (id)placeCardPresenterForContentViewController:(id)arg1 withPresentionChangeHandler:(CDUnknownBlockType)arg2;
