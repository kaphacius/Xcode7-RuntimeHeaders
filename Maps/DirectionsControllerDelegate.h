...
- (void)directionsController:(DirectionsController *)arg1 isRecalculating:(_Bool)arg2;
...
- (void)directionsControllerDidFailToLoadMoreRoutes:(DirectionsController *)arg1 withError:(NSError *)arg2 canInterruptUser:(_Bool)arg3;
- (void)directionsControllerDidFailToLoadInitialRoutes:(DirectionsController *)arg1 withError:(NSError *)arg2 canInterruptUser:(_Bool)arg3;
