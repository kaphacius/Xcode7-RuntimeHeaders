...
@optional
- (_Bool)placePresentationSelectionManager:(PlacePresentationSelectionManager *)arg1 requiresMapsSelectionForPresentingPlacecardInContext:(PlacePresentationSelectionManagerContext *)arg2;
...
- (void)selectedSearchResultDidChange:(SearchResult *)arg1;
