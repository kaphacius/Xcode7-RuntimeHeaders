...
@interface MainChromeViewItem : MapsChromeViewItem
{
    ...
    _Bool _detailsBarInteractionEnabled;
...
@property(nonatomic, getter=isDetailsBarInteractionEnabled) _Bool detailsBarInteractionEnabled; // @synthesize detailsBarInteractionEnabled=_detailsBarInteractionEnabled;
