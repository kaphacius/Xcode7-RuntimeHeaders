...
- (double)_getPortionForStep:(id)arg1 withSecondary:(id)arg2 basedOnOptions:(CDStruct_82c04388 *)arg3;
- (_Bool)_setInstructionContentForStep:(id)arg1 withSecondary:(id)arg2 optionsToSet:(CDStruct_82c04388 *)arg3 basedOnPortion:(double)arg4;
