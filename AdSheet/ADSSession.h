...
@interface ADSSession : NSObject <ADSSession_RPC, ADClientStateDelegate>
{
    ...
    _Bool _unlimitedControllersAllowed;
...
@property(readonly, nonatomic) _Bool unlimitedControllersAllowed; // @synthesize unlimitedControllersAllowed=_unlimitedControllersAllowed;
...
- (void)_remote_requestAttributionDetailsWithBlock:(CDUnknownBlockType)arg1;
...
- (void)_remote_requestAdsForContext:(id)arg1 serverURL:(id)arg2 creativeTypes:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
