...
- (void)mapView:(MKMapView *)arg1 didStopRespondingToGesture:(int)arg2 zoomDirection:(int)arg3 didDecelerate:(_Bool)arg4;
- (void)mapView:(MKMapView *)arg1 willStartRespondingToGesture:(int)arg2 animated:(_Bool)arg3;
...
- (void)mapView:(MKMapView *)arg1 didChangeMapType:(unsigned int)arg2;
- (void)mapViewDidFinishInitialUserTrackingModeAnimation:(MKMapView *)arg1;
- (void)mapView:(MKMapView *)arg1 didChangeUserTrackingMode:(int)arg2 animated:(_Bool)arg3 fromTrackingButton:(_Bool)arg4;
