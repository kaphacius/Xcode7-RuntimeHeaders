...
@property(readonly, nonatomic) unsigned int vehicleIndex; // @synthesize vehicleIndex=_vehicleIndex;
...
- (id)initWithBoardStep:(id)arg1 vehicleIndex:(unsigned int)arg2;
