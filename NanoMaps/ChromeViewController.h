...
@interface ChromeViewController : UIViewController <MKMapViewDelegate, MKMapViewDelegatePrivate, MapsChromeViews>
{
    ...
    unsigned int _clientsAllowingInsetsAnimation;
...
- (id)mapViewDelegate;
- (_Bool)getPreferredUserInterfaceIdiom:(out int *)arg1;
...
- (struct CGRect)unobscuredBoundsInContainingViewWithOptions:(int)arg1;
...
- (void)_popToItem:(id)arg1 atIndex:(unsigned int)arg2 animated:(_Bool)arg3;
...
- (void)mapView:(id)arg1 willStartRespondingToGesture:(int)arg2 animated:(_Bool)arg3;
...
- (void)mapView:(id)arg1 didChangeMapType:(unsigned int)arg2;
...
- (void)mapView:(id)arg1 didChangeUserTrackingMode:(int)arg2 animated:(_Bool)arg3;
