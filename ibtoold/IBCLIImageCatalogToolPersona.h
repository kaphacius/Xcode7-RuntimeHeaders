...
- (void)compileCatalogCollection:(id)arg1 withPlatformAdapter:(id)arg2 arguments:(id)arg3 outputDictionary:(id)arg4;
- (void)reportCompilerResults:(id)arg1 forCatalogCollection:(id)arg2 arguments:(id)arg3 outputDictionary:(id)arg4;
- (id)toolName;
