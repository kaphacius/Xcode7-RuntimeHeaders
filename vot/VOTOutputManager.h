...
@interface VOTOutputManager : NSObject
{
    ...
    unsigned long long _currentExternalRoutingState;
...
- (void)speakSimpleString:(id)arg1 braille:(_Bool)arg2 language:(id)arg3;
...
- (_Bool)externalAudioRouteSelected;
