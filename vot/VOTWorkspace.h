...
@property(nonatomic) _Bool audioDestinationIsExternal; // @synthesize audioDestinationIsExternal=_audioDestinationIsExternal;
...
@property(nonatomic) long long brailleGesturesTypingFeedback; // @synthesize brailleGesturesTypingFeedback=_brailleGesturesTypingFeedback;
...
- (_Bool)screenOn;
- (void)setScreenOn:(_Bool)arg1 silently:(_Bool)arg2;
...
- (void)_voiceOverTouchEnabledChange:(struct __CFString *)arg1;
