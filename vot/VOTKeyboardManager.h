...
@interface VOTKeyboardManager : NSObject
{
    ...
    _Bool _modifierToggleSpeakingKeyDown;
    ...
    _Bool _realCapsLockOn;
    _Bool _fakeCapsLockOn;
    ...
    _Bool _capsLockDown;
    _Bool _modifierKeyLockEnabled;
    double _capsLockTap1;
    _Bool _controlKeyToggleSpeakingAllowed;
    CDUnknownBlockType _testingEventDispatchTap;
}
...
- (void)_handleKeyboardKeyEvent:(id)arg1 isRepeatedEvent:(_Bool)arg2;
...
- (_Bool)_keyEventShouldGoToFocusedContext:(id)arg1;
...
- (_Bool)_dispatchCommandForKeyInfo:(id)arg1 isRepeatedEvent:(_Bool)arg2;
