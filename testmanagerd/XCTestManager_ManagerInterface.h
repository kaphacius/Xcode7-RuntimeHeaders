...
- (void)_XCT_sendString:(NSString *)arg1 maximumFrequency:(unsigned int)arg2 completion:(void (^)(NSError *))arg3;
- (void)_XCT_updateDeviceOrientation:(int)arg1 completion:(void (^)(NSError *))arg2;
...
- (void)_XCT_exchangeProtocolVersion:(unsigned int)arg1 reply:(void (^)(unsigned int))arg2;
@end