...
- (void)bindParametersForAchievementsStatement:(struct sqlite3_stmt *)arg1 achievement:(id)arg2 shouldScreen:(_Bool)arg3 eligibleChallenges:(id)arg4 requestsRowID:(long long)arg5;
- (id)achievementsInsertSQL;
- (void)bindParametersForRequestsStatement:(struct sqlite3_stmt *)arg1 achievevement:(id)arg2 digest:(id)arg3;
