...
- (void)bindParametersForStatement:(struct sqlite3_stmt *)arg1 forAbortingChallenge:(id)arg2 requestsRowID:(long long)arg3;
- (void)bindParametersForStatement:(struct sqlite3_stmt *)arg1 forIssuingChallenge:(id)arg2 requestsRowID:(long long)arg3;
