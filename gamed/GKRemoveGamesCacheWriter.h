...
- (void)bindParametersForRemoveGamesStatement:(struct sqlite3_stmt *)arg1 forRemovedBundleID:(id)arg2 requestsRowID:(long long)arg3;
- (id)removeGamesInsertSQL;
- (void)bindParametersForRequestsStatement:(struct sqlite3_stmt *)arg1 playerID:(id)arg2 digest:(id)arg3;
