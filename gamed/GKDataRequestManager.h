...
- (void)finishStartup;
- (void)clientProxy:(id)arg1 didRefreshContentsForDataType:(unsigned int)arg2 userInfo:(id)arg3;
- (oneway void)processQuickAction:(id)arg1;
- (void)updateQuickActionsForbundleID:(id)arg1;
- (void)updateAllQuickActions;
- (void)updateQuickItems:(struct NSArray *)arg1 forBundleID:(id)arg2;
