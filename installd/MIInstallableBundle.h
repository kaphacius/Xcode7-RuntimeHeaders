...
- (_Bool)_isValidWatchKitApp:(id)arg1 withVersion:(unsigned int)arg2 isValidatedByProfile:(_Bool)arg3 error:(id *)arg4;
- (_Bool)performPreflightWithError:(id *)arg1;
- (_Bool)_validateITunesMetadataOptionWithError:(id *)arg1;
...
@property(retain) MIExecutableBundle *bundle; // @dynamic bundle;
