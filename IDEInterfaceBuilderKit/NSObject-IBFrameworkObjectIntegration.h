...
- (void)setIbSceneUpdateWarningMessages:(id)arg1;
- (id)ibSceneUpdateWarningMessages;
- (void)setIbSceneUpdateError:(id)arg1;
- (id)ibSceneUpdateError;
- (BOOL)ibShouldInvalidateSceneForChangeToKeyPath:(id)arg1;
