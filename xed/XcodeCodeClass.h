...
@interface XcodeCodeClass : SBObject
{
}
...
@property(copy) NSString *superclasses;
@property(readonly) BOOL projectMember;
@property(copy) NSString *name;
@property(readonly) int implementationLanguage;
@property int hideAction;
@property(readonly) BOOL hiddenPerFilter;
@property(readonly) BOOL hiddenInDiagram;
@property(readonly) BOOL category;
