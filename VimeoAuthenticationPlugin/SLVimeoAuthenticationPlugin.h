...
- (id)_consumerSecret;
- (id)_consumerKey;
- (void)_handleAccessTokenResponseData:(id)arg1 forAccount:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)_authenticationAccount:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;
- (_Bool)_isClientEntitledToAccessVimeo:(id)arg1;
